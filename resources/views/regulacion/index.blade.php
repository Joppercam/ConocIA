...
<div class="container py-5">
    <div class="row g-5">
        ...
        <div class="col-lg-3 d-none d-lg-block">
            <nav class="sidebar-nav" style="position:sticky;top:88px;z-index:10;">
                ...
                <ul style="list-style:none;padding:0;margin:0;" class="d-flex flex-column gap-1">
                    <li>
                        <button class="sidebar-link active w-100 text-start border-0 bg-transparent d-flex align-items-center gap-2" data-target="proyecto-ley">
                            <span style="font-size:.85rem;">📋</span><span>Proyecto de Ley Chile</span>
                        </button>
                    </li>
                    <li>
                        <button class="sidebar-link w-100 text-start border-0 bg-transparent d-flex align-items-center gap-2" data-target="opiniones">
                            <span style="font-size:.85rem;">💬</span><span>¿Qué opinan?</span>
                        </button>
                    </li>
                    <li>
                        <button class="sidebar-link w-100 text-start border-0 bg-transparent d-flex align-items-center gap-2" data-target="comparador">
                            <span style="font-size:.85rem;">🌍</span><span>Comparador</span>
                        </button>
                    </li>
                    <li>
                        <button class="sidebar-link w-100 text-start border-0 bg-transparent d-flex align-items-center gap-2" data-target="otras">
                            <span style="font-size:.85rem;">📚</span><span>Otras regulaciones</span>
                        </button>
                    </li>
                </ul>
        ...
        <div class="col-lg-9">
            ...
            {{-- ══ PANEL: Proyecto de Ley ══ --}}
            <div data-panel="proyecto-ley">
                ...
                <div class="mt-4 p-3" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:.5rem;">
                    <p class="mb-0" style="color:#94a3b8;font-size:.78rem;line-height:1.6;">
            ...
            {{-- ══ PANEL: Opiniones ══ --}}
            <div data-panel="opiniones" style="display:none;">
                ...
                <div class="d-flex flex-column gap-4">
                    ...
                    <div style="border:1px solid #e2e8f0;border-left:4px solid {{ $voice['postura_color'] }};border-radius:0 .75rem .75rem 0;padding:1.5rem 1.75rem;background:#fff;">
                        ...
                        <p style="color:#1e293b;font-size:.95rem;font-weight:500;line-height:1.7;margin-bottom:.875rem;">{{ $voice['summary'] }}</p>
                        <p style="color:#475569;font-size:.9rem;line-height:1.9;margin-bottom:1rem;">{{ $voice['context'] }}</p>
            ...
            {{-- ══ PANEL: Comparador ══ --}}
            <div data-panel="comparador" style="display:none;">
                        ...
                        <table class="table table-borderless mb-0" style="font-size:.86rem;">
                            ...
                            <tbody>
                                <tr style="border-bottom:1px solid #f1f5f9;">
                                    ...
                                    <td style="padding:.875rem 1.25rem;"><span class="badge" style="background:#f59e0b22;color:#b45309;border:1px solid #f59e0b44;font-size:.73rem;white-space:nowrap;">En tramitación</span></td>
                                ...
                                <tr style="border-bottom:1px solid #f1f5f9;">
                                    ...
                                    <td style="padding:.875rem 1.25rem;color:#334155;">Ley basada en riesgo</td>
                                    <td style="padding:.875rem 1.25rem;"><span class="badge" style="background:#10b98122;color:#065f46;border:1px solid #10b98144;font-size:.73rem;">Vigente</span></td>
            ...
            {{-- ══ PANEL: Otras regulaciones ══ --}}
            <div data-panel="otras" style="display:none;">
                ...
                <div class="d-flex flex-column gap-2 mb-4">
                    ...
                    <div class="d-flex align-items-start gap-3 p-3" style="border:1px solid #e2e8f0;border-radius:.625rem;background:#fff;">
                        ...
                        @if($reg->content)
                        <a href="{{ route('regulacion.show', $reg->slug) }}" class="btn btn-sm btn-outline-primary flex-shrink-0 align-self-center" style="font-size:.78rem;white-space:nowrap;">
                ...
                <div class="mt-4 p-3" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:.625rem;">
                    <p class="mb-0" style="color:#94a3b8;font-size:.78rem;line-height:1.65;">
                        <i class="fas fa-info-circle me-1"></i>
                        Observatorio mantenido por ConocIA con fines de divulgación. No constituye asesoría legal.
...
.sidebar-link:hover { background: rgba(56,182,255,.08); color: var(--primary-color); }
.sidebar-link.active { background: rgba(56,182,255,.12); color: var(--primary-color); font-weight: 600; }
.reg-content h2 { font-size:1.1rem;font-weight:700;color:#0f172a;margin-top:1.75rem;margin-bottom:.625rem;padding-bottom:.4rem;border-bottom:2px solid rgba(56,182,255,.15); }
.reg-content h2:first-child { margin-top:0; }
.reg-content h3 { font-size:.95rem;font-weight:700;color:#1e40af;margin-top:1.25rem;margin-bottom:.4rem; }
.reg-content p { color:#475569;font-size:.95rem;line-height:1.875;margin-bottom:.875rem; }
.reg-content ul,.reg-content ol { color:#475569;font-size:.95rem;line-height:1.875;padding-left:1.5rem;margin-bottom:.875rem; }

...
return new class extends Migration
{
    ...
    {
        // Esta migración aplica el contenido expandido a actores ya existentes.
        // updateOrInsert por slug garantiza idempotencia.
        $updates = [
            'cenia-centro-nacional-de-inteligencia-artificial' => [
                'director'    => 'Álvaro Soto',
                'founded'     => 'Noviembre 2021',
                'key_facts'   => json_encode(['200+ personas en el equipo', '15+ universidades participantes', '4 universidades fundadoras: PUC, U. de Chile, UAI, UTFSM', '5 líneas de investigación', 'Publicaciones en NeurIPS, CVPR, EMNLP, ICLR', '9 alianzas con empresas e instituciones públicas']),
                'focus_areas' => json_encode(['Aprendizaje profundo', 'NLP', 'Visión por computadora', 'IA ética', 'Neurociencia computacional']),
            ...
            'instituto-de-datos-e-inteligencia-artificial-idia-universidad-de-chile' => [
                ...
                'key_facts'   => json_encode(['Universidad pública más antigua de Chile', 'Investigadores en CENIA, IMFD y otros centros', 'Aloja el NLHPC (supercomputación)', 'Académicos destacados: Bárbara Poblete, Andrés Abeliuk']),
                'focus_areas' => json_encode(['Machine Learning', 'Data Science', 'Computación de alto rendimiento', 'IA ética']),
            ...
            'vicerrectoria-de-inteligencia-digital-puc' => [
                'founded'     => '2025',
                'key_facts'   => json_encode(['Primera Vicerrectoría de Inteligencia Digital en Chile', 'Una de las primeras en Latinoamérica', 'Lidera CENIA (a través del prof. Álvaro Soto)', 'Aloja el IMC']),
            ...
            'instituto-de-ingenieria-matematica-y-computacional-imc-puc' => [
                'key_facts'   => json_encode(['Centro interdisciplinario de la PUC', 'Participación activa en CENIA', 'Investiga causalidad en modelos de IA']),
            ...
            'nlhpc-laboratorio-nacional-de-computacion-de-alto-rendimiento' => [
                'key_facts'   => json_encode(['Infraestructura nacional de supercomputación', 'Alojado en la Universidad de Chile', 'Abierto a toda la comunidad académica chilena', 'Base para entrenamiento de modelos de IA']),
            ...
            'csiaa-centro-chileno-de-supercomputo-para-ia-aplicada' => [
                'founded'     => '2026',
                'key_facts'   => json_encode(['US$7 millones de financiamiento CORFO', '65 instituciones en el consorcio', 'Operativo desde 2026', 'Accesible para pymes, startups y academia', 'Incluye acompañamiento técnico y créditos de uso']),
                'focus_areas' => json_encode(['Supercómputo', 'IA aplicada', 'Infraestructura cloud', 'Democratización tecnológica']),
            ...
            'imfd-instituto-milenio-fundamentos-de-los-datos' => [
                'key_facts'   => json_encode(['Centro Milenio de excelencia', 'Investigación sobre desinformación y IA', 'Investigadores: Bárbara Poblete, Marcelo Mendoza']),
                'focus_areas' => json_encode(['Fundamentos de datos', 'Transparencia algorítmica', 'IA ética', 'Desinformación', 'Seguridad']),
            ...
            'universidad-tecnica-federico-santa-maria' => [
                'key_facts'   => json_encode(['Universidad fundadora de CENIA', 'Participación en IMFD', 'Polo de IA regional fuera de Santiago', 'Investigador destacado: Marcelo Mendoza']),
                'focus_areas' => json_encode(['NLP', 'Minería de datos', 'Seguridad IA', 'Transparencia algorítmica']),
            ...
            'universidad-de-santiago-de-chile-usach' => [
                'key_facts'   => json_encode(['Alianza con MIT en IA aplicada', 'Investigación en IA para minería y ciencias planetarias', 'Publicaciones indexadas internacionales', 'Investigador destacado: Alberto Fernández (Minas)']),
                'focus_areas' => json_encode(['IA en minería', 'Machine Learning', 'Colaboración MIT', 'Ciencias planetarias']),
            ...
            'universidad-autonoma-de-chile' => [
                'key_facts'   => json_encode(['Proyecto IA-Design activo', 'Blockchain para certificaciones académicas', 'Alianzas internacionales en educación + IA', 'Ecosistema integral de innovación educativa']),
                'focus_areas' => json_encode(['IA en educación', 'IA-Design', 'Innovación educativa', 'Blockchain']),
            ...
            'universidad-de-talca' => [
                'key_facts'   => json_encode(['Integrante del consorcio SCAI-Lab', 'Investigación en IA para salud y agricultura regional', 'Polo regional de IA en la Región del Maule', 'Formación de estudiantes en tecnologías emergentes']),
                'focus_areas' => json_encode(['IA en salud', 'IA en agricultura', 'Supercómputo', 'Investigación regional']),
            ...
            'ednova' => [
                ...
                'key_facts'   => json_encode(['Referente LATAM en edtech + IA', 'Fundada por Valeria Silva', 'Algoritmos de adaptación del aprendizaje', 'Rankings startups IA LATAM 2026']),
            ...
            'eclectic' => [
                'key_facts'   => json_encode(['Modelo de crecimiento lean + IA', 'Automatización de procesos operativos', 'Equipo pequeño con alto apalancamiento en IA']),
                'focus_areas' => json_encode(['Automatización', 'Productividad con IA', 'Operaciones lean']),
            ...
            'ministerio-de-ciencia-tecnologia-conocimiento-e-innovacion' => [
                'key_facts'   => json_encode(['Impulsa proyecto de ley de IA (Boletín 16821-19, en el Senado)', 'Chile PotencIA: 600+ postulaciones, 162 proyectos seleccionados', 'Plan Nacional de Data Centers', '22 data centers operativos + 28 proyectados', 'Certificación ChileValora en IA']),
                'focus_areas' => json_encode(['Política pública IA', 'Regulación', 'Fomento CTCI', 'Data Centers']),
            ...
            'corfo-corporacion-de-fomento-de-la-produccion' => [
                'key_facts'   => json_encode(['US$7 millones para infraestructura SCAI-Lab/CSIAA', 'Fondos para startups de IA', 'Programas de innovación tecnológica productiva', 'Proyecta mejoras +10% en productividad minera y agroindustrial']),
                'focus_areas' => json_encode(['Financiamiento', 'Innovación', 'Supercómputo', 'Startups']),
            ...
            'fundacion-pais-digital' => [
                'key_facts'   => json_encode(['Co-organiza Premio Chile PotencIA con el Ministerio de Ciencia', '600+ postulaciones recibidas en 2025', '4 categorías: Startups, Pymes, Grandes Empresas, Organizaciones', 'Jurado mixto: sector público, academia y expertos internacionales']),
                'focus_areas' => json_encode(['Transformación digital', 'Premio Chile PotencIA', 'Divulgación', 'Inclusión digital']),
            ...
            'ai-adoption-initiative-aiai' => [
                'key_facts'   => json_encode(['Evaluador experto del Premio Chile PotencIA', 'Acompañamiento para adopción de IA en organizaciones', 'Criterios técnicos y de impacto en evaluaciones']),

...
Route::get('/planes', fn() => redirect('/')->name('billing.plans'));
Route::post('/planes/{plan}', fn() => redirect('/'))->name('billing.select');
...
Route::middleware('auth')->group(function () {
    Route::get('/app', fn() => redirect('/profile'))->name('saas.dashboard');
...
Route::prefix('cp-conocia')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', \App\Http\Middleware\AdminMiddleware::class])->group(function () {
        ...
        Route::prefix('agente-editorial')->name('editorial-agent.')->group(function () {
            ...
            Route::get('/bitacora', [\App\Http\Controllers\Admin\EditorialAgentController::class, 'logs'])->name('logs');
            Route::patch('/acciones-masivas', [\App\Http\Controllers\Admin\EditorialAgentController::class, 'bulkAction'])->name('bulk-action');
